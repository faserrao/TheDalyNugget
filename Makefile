...
DN_SES_DNS_TXT_REC_NAME					:= _amazonses.$(DN_DOMAIN)
...
print_variables:
	$(info DN_SES_DNS_TXT_REC_VAL="$(DN_SES_DNS_TXT_REC_VAL)")
	$(info DN_ROOT_PREFIX ="$(DN_ROOT_PREFIX)")
	$(info DN_ROOT_PREFIX_NO_DASHES="$(DN_ROOT_PREFIX_NO_DASHES)")
	$(info DN_SERVICE_PREFIX_DASHES ="$(DN_SERVICE_PREFIX_DASHES)")
	$(info DN_SERVICE_PREFIX_NO_DASHES="$(DN_SERVICE_PREFIX_NO_DASHES)")
	$(info DN_SERVICE_PREFIX_NO_DASHES_UPPER_T="$(DN_SERVICE_PREFIX_NO_DASHES_UPPER_T)")
	$(info DN_DOMAIN="$(DN_DOMAIN)")
	$(info DN_ROOT_PREFIX_PASCAL_CASE="$(DN_ROOT_PREFIX_PASCAL_CASE)")
...
#deploy: clean deploy_ses_identities deploy_serverless seed_dynamo deploy_apigateway deploy_static deploy_ses_rules
deploy: clean_local deploy_ses_identities deploy_serverless seed_dynamo deploy_apigateway deploy_static deploy_ses_rules
#deploy: clean deploy_ses_identities deploy_serverless seed_dynamo deploy_ses_rules deploy_apigateway
#deploy: clean deploy_ses_identities deploy_serverless seed_dynamo deploy_ses_rules
#deploy: clean deploy_ses_identities deploy_serverless seed_dynamo
